...
89 Markdown files, all with valid front matter as of the last run.
...
| `plan/agents/README.md` | Agent Cards | live | agentic-sdlc | shared | agent-card |  |  |
| `plan/agents/baseline-guard.md` | Baseline Guard | live | agentic-sdlc | shared | agent-card |  |  |
| `plan/agents/budget-accountant.md` | Budget Accountant | live | agentic-sdlc | core | agent-card |  |  |
| `plan/agents/budget-enforcer.md` | Budget Enforcer | live | agentic-sdlc | core | agent-card |  |  |
| `plan/agents/card_schema.md` | Agent Card Schema | live | agentic-sdlc | core | card-schema |  |  |
| `plan/agents/ci-cleanup.md` | CI Cleanup | live | agentic-sdlc | adapter-sdlc | agent-card |  |  |
| `plan/agents/code-reviewer.md` | Code Reviewer | live | agentic-sdlc | shared | agent-card |  |  |
| `plan/agents/context-gatherer.md` | Context Gatherer | live | agentic-sdlc | core | agent-card |  |  |
| `plan/agents/core-orchestrator.md` | Core Orchestrator | live | agentic-sdlc | core | agent-card |  |  |
| `plan/agents/error-analyzer.md` | Error Analyzer | live | agentic-sdlc | core | agent-card |  |  |
| `plan/agents/flake-registry.md` | Flake Registry | live | agentic-sdlc | adapter-sdlc | agent-card |  |  |
| `plan/agents/integrator.md` | Integrator | live | agentic-sdlc | adapter-sdlc | agent-card |  |  |
| `plan/agents/invariant-curator.md` | Invariant Curator | live | agentic-sdlc | core | agent-card |  |  |
| `plan/agents/log-monitor.md` | Log Monitor | live | agentic-sdlc | core | agent-card |  |  |
| `plan/agents/plan-reviewer.md` | Plan Reviewer | live | agentic-sdlc | core | agent-card |  |  |
| `plan/agents/plan-writer.md` | Plan Writer | live | agentic-sdlc | core | agent-card |  |  |
| `plan/agents/pr-reviewer.md` | PR Reviewer | live | agentic-sdlc | adapter-sdlc | agent-card |  |  |
| `plan/agents/security-review-plan.md` | Security Review (plan-time) | live | agentic-sdlc | shared | agent-card |  |  |
| `plan/agents/security-reviewer-diff.md` | Security Reviewer (diff-time) | live | agentic-sdlc | adapter-sdlc | agent-card |  |  |
| `plan/agents/shared-file-intent-service.md` | Shared-File Intent Service | live | agentic-sdlc | core | agent-card |  |  |
| `plan/agents/task-decomposer.md` | Task Decomposer | live | agentic-sdlc | core | agent-card |  |  |
| `plan/agents/task-dev-swarm.md` | Task Dev Swarm | live | agentic-sdlc | shared | agent-card |  |  |
| `plan/agents/test-author.md` | Test Author | live | agentic-sdlc | adapter-sdlc | agent-card |  |  |
| `plan/agents/test-investigator.md` | Test Investigator | live | agentic-sdlc | adapter-sdlc | agent-card |  |  |
| `plan/agents/test-runner.md` | Test Runner | live | agentic-sdlc | adapter-sdlc | agent-card |  |  |
| `plan/agents/types/archivist.md` | Archivist (Agent Type) | live | agentic-sdlc | core | agent-type |  |  |
| `plan/agents/types/checker.md` | Checker (Agent Type) | live | agentic-sdlc | core | agent-type |  |  |
| `plan/agents/types/executor.md` | Executor (Agent Type) | live | agentic-sdlc | core | agent-type |  |  |
| `plan/agents/types/maker.md` | Maker (Agent Type) | live | agentic-sdlc | core | agent-type |  |  |
| `plan/agents/types/orchestrator.md` | Orchestrator (Agent Type) | live | agentic-sdlc | core | agent-type |  |  |
| `plan/agents/types/provider.md` | Provider (Agent Type) | live | agentic-sdlc | core | agent-type |  |  |
| `plan/agents/vault-checker.md` | Vault Checker | draft | agentic-sdlc | core | agent-card |  |  |
| `plan/agents/vault-scribe.md` | Vault Scribe | draft | agentic-sdlc | core | agent-card |  |  |
...
| `plan/core_vs_adapter.md` | Core vs. Adapter Classification | live | repo-meta | shared | classification |  |  |
...
| `plan/optimization/agents/continuity-assistant.md` | Continuity Assistant | draft | optimization | adapter-team | agent-card |  |  |
| `plan/optimization/agents/evidence-retriever.md` | Evidence Retriever | draft | optimization | adapter-team | agent-card |  |  |
| `plan/optimization/agents/project-state-validator.md` | Project-State Validator | draft | optimization | adapter-team | agent-card |  |  |
| `plan/optimization/agents/quality-reviewer.md` | Quality Reviewer | draft | optimization | adapter-team | agent-card |  |  |
| `plan/optimization/agents/status-synthesizer.md` | Status Synthesizer | draft | optimization | adapter-team | agent-card |  |  |
| `plan/optimization/charter.md` | Optimization System Charter | draft | optimization | shared | companion |  |  |
| `plan/optimization/delivery_pulse_runbook.md` | Delivery Pulse Runbook | draft | optimization | adapter-team | runbook |  |  |
| `plan/optimization/personal_adapter.md` | Personal Optimization Adapter | draft | optimization | adapter-personal | companion |  |  |
| `plan/optimization/project_state_model.md` | Project State Model | draft | optimization | adapter-team | companion |  |  |
| `plan/optimization/routing_standard.md` | Routing Standard | draft | optimization | shared | companion |  |  |
...
| `plan/work_packet_contract.md` | Work Packet Contract | draft | agentic-sdlc | core | companion |  |  |
