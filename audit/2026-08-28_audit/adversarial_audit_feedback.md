...
*(Note: Clarifying questions Q1–Q6 are handled separately in [audit_questions_response.md](file:///code/agent-swarm/agent-swarm/audit/2026-08-28_audit/audit_questions_response.md).)*
...
- **Location:** [core_adapter_boundary.md §5](file:///code/agent-swarm/agent-swarm/plan/core_adapter_boundary.md)
...
- **Location:** [agentic-sdlc-design-v0.5.md §4.5](file:///code/agent-swarm/agent-swarm/plan/agentic-sdlc-design-v0.5.md#L138-L139), [agent_interface_contracts.py](file:///code/agent-swarm/agent-swarm/plan/agent_interface_contracts.py)
...
- **Location:** [agent_interface_contracts.py `GateApplicability`](file:///code/agent-swarm/agent-swarm/plan/agent_interface_contracts.py), [agentic-sdlc-design-v0.5.md §9.1](file:///code/agent-swarm/agent-swarm/plan/agentic-sdlc-design-v0.5.md#L216-L217)
...
- **Location:** [execution_isolation.md §7](file:///code/agent-swarm/agent-swarm/plan/execution_isolation.md), [agentic-sdlc-design-v0.5.md §4.7](file:///code/agent-swarm/agent-swarm/plan/agentic-sdlc-design-v0.5.md#L144-L156)
...
- **Location:** [CLAUDE.md L20-22](file:///code/agent-swarm/agent-swarm/CLAUDE.md#L20-L22) vs. [agent_interface_contracts.py](file:///code/agent-swarm/agent-swarm/plan/agent_interface_contracts.py)
...
- **Location:** [calibration_and_measurement.md §1](file:///code/agent-swarm/agent-swarm/plan/calibration_and_measurement.md#L26-L38)
...
- **Location:** [budget_and_escalation_policy.md §1](file:///code/agent-swarm/agent-swarm/plan/budget_and_escalation_policy.md#L20-L25)
...
- **Location:** [test_harness_architecture.md §1.2](file:///code/agent-swarm/agent-swarm/plan/test_harness_architecture.md#L24-L64)
...
- **Location:** [core_adapter_boundary.md §1.2](file:///code/agent-swarm/agent-swarm/plan/core_adapter_boundary.md#L39-L49)
...
- **Location:** [structural_change_runbook.md](file:///code/agent-swarm/agent-swarm/plan/structural_change_runbook.md)
...
- **Location:** [agent_interface_contracts.py L13-16](file:///code/agent-swarm/agent-swarm/plan/agent_interface_contracts.py#L13-L16)
...
- **Location:** [core_adapter_boundary.md §2.1](file:///code/agent-swarm/agent-swarm/plan/core_adapter_boundary.md#L61-L74), [agent_interface_contracts.py](file:///code/agent-swarm/agent-swarm/plan/agent_interface_contracts.py)
...
- **Location:** [agentic-sdlc-design-v0.5.md §3](file:///code/agent-swarm/agent-swarm/plan/agentic-sdlc-design-v0.5.md#L100-L103)
...
- **Finding:** [agentic_sdlc_glossary.csv](file:///code/agent-swarm/agent-swarm/plan/agentic_sdlc_glossary.csv) is cumbersome to review in PRs and prone to drift.
...
- **Finding:** Vector search struggles with custom DSLs ([context_retrieval_strategy.md](file:///code/agent-swarm/agent-swarm/plan/context_retrieval_strategy.md)); broad-then-narrow forces unnecessary sequential latency when target files are already known.
...
- **Finding:** Async background browser events can dirty DOM state, misclassifying logic bugs as infra triage failures ([infra_triage_matrix.md](file:///code/agent-swarm/agent-swarm/plan/infra_triage_matrix.md)).
